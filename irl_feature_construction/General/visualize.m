...
if ~suppress_intermediate,
    ...
    if isfield(test_result.irl_result,'r_itr'),
        ...
        for i=1:num_itr,
            ...
            title(sprintf('%s: optimization result at iteration %d', ...
                test_result.algorithm, i));
            ...
            title(sprintf('%s: fitting result at iteration %d', ...
                test_result.algorithm, i));
...
title(sprintf('Reward for ground truth of %s', test_result.mdp));
...
title(sprintf('Reward for %s result', test_result.algorithm));
