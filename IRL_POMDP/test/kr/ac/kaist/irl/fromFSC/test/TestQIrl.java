...
import kr.ac.kaist.irl.fromFSC.QIrl;
...
/**
 * junit test case for IRL using Q-function based optimality constraint.
 * 
 * @author Jaedeug Choi (jdchoi@ai.kaist.ac.kr)
 *
 */
public class TestQIrl extends TestCase {
	...
	private boolean expPrint = true; //false;;
	private Random rand;
...
//		repeatedExp();
	...
	public double singleExp() throws Exception {
		...
		System.out.printf("Q-function IRL : %s\n\n", probName);
		...
		// inverse reinforcement learning comparing Q-functions
		QIrl irl = new QIrl(pomdpProb, fsc, nBeliefs, minDist, irlPrint, rand);
		System.out.println("=== Q-function Irl ====================================");
