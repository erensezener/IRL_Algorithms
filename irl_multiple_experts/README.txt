Inverse reinforcement learning (IRL) for multiple experts

- Jaedeug Choi (jdchoi@ai.kaist.ac.kr)

This package contains the algorithms of IRL when the behavior data is provided by multiple experts. The algorithms are described in [ChoiKim.12].
